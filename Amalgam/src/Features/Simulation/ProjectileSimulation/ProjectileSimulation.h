...
public:
	// Finds a command number that produces minimal rotation for projectiles
	int FindNoPillRotationCommandNumber(CTFPlayer* pPlayer, CTFWeaponBase* pWeapon, CUserCmd* pCmd);
